...
esp_err_t esp_eth_init(esp_eth_handle_t *eth_handles_out)
{
    ...
    ESP_GOTO_ON_FALSE(eth_handles_out != NULL, ESP_ERR_INVALID_ARG, err, TAG, "invalid arguments: initialized handles array");
    ...
    spi_eth_module_config_t spi_eth_module_config = {
        ...
        .polling_ms = CONFIG_ETH_SPI_POLLING0_MS,
 ...
 * @return esp_eth_handle_t if init succeeded or NULL if init failed
 */
static esp_eth_handle_t eth_init_spi(spi_eth_module_config_t *spi_eth_module_config, esp_eth_mac_t **mac_out, esp_eth_phy_t **phy_out)
{
